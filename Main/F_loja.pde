...
void loja(){
  ...
  b3.append(25);
  b3.append(190);
  b3.append(botao3Imagem.width);
  b3.append(botao3Imagem.height);
  b4.append(150);
  b4.append(100);
  b4.append(botao4Imagem.width);
  b4.append(botao4Imagem.height);
  ...
  image(botao4Imagem, b4.get(0), b4.get(1));
