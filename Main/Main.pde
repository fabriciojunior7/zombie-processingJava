...
//Inicio: 14/09/2017
//Ultima Atualizacao: 02/12/2017
//Fim: ?

Jogador p1;
int fps = 60;
int numZombies = 1;
int balasRevolver = 16;
...
PImage botao1Imagem, botao2Imagem, botao3Imagem, botao4Imagem;
PImage revolverImagem;
PImage metralhadoraImagem;
